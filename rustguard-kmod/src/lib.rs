...
unsafe fn handle_transport(
    ...
    unsafe {
        ...
        // Zero-copy in-place decrypt via skb_cow_data + skb_to_sgvec.
        // Same approach as kernel WireGuard (receive.c:270).
        ...
        // Strip header, trim AEAD tag — plaintext remains in the skb.
